...
import { Box, Paper, Collapse, Menu, MenuItem, IconButton, Popover, Typography, Button } from "@mui/material";
...
export default function NoteCard({
  ...
  const handleConfirmPopover = (e: React.MouseEvent<HTMLElement>, action: () => void) => {
    e.stopPropagation();
