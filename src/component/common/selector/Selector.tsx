...
const Selector = ({ label, value, onChange, options, disabled = false, children }: SelectorProperties) => {
  ...
  return (
    <FormControl fullWidth size="small" disabled={disabled}>
      ...
      <Select
        ...
        renderValue={() => (selectedOption && children ? children(selectedOption) : (selectedOption?.label ?? ""))}
      >
        {options.map((option) => (
